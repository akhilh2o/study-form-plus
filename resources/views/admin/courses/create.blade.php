            ...
            <form action="{{ route('admin.courses.store') }}" method="POST" class="card shadow-sm"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control text-editor" id="description" rows="10"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="meta_description" class="form-control" id="meta_description" rows="2"></textarea>
                    </div>
                </div>
