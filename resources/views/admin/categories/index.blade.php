<x-admin.layout>
    <x-admin.breadcrumb title='All Categories' :links="[
                ...
                [
                    ...
                    'url'   => route('admin.categories.index', ['filter' => 1])
                ],
                [
                    'text'       => 'Create New',
                    'icon'       => 'fas fa-plus',
            ...
            <form action="">
                <div class="row">
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <a href="{{ route('admin.categories.index') }}" class="btn btn-basic border btn-loader">
                    ...
                    <tr>
                        ...
                        <td width="25%">
                            <form action="{{ route('admin.categories.create') }}" class="d-inline-block">
                                ...
                                <button class="btn btn-sm btn-warning btn-loader load-circle" title="Add Subcategory">
