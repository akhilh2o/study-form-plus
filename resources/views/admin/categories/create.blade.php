            ...
            <form action="{{ route('admin.categories.store') }}" method="POST" class="card shadow-sm"
                ...
                <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="parent_id" class="form-control select2">
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}" @selected(request()->get('parent_id') == $category->id)>
                        ...
                        <div class="col-sm-4 col-12">
                            <div class="form-group">
                                ...
                                <select name="is_popular" class="form-control select2">
                                    ...
                                    <option value="0" {{ old('is_popular', '0') == '0' ? 'selected' : '' }}>No
                                    </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="meta_keyword" class="form-control" id="meta_keyword" cols="30" rows="2"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="meta_description">Meta Description</label>
                        <textarea name="meta_description" class="form-control" id="meta_description" cols="30" rows="2"></textarea>
                    </div>
                </div>
